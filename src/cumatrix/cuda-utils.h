...
#define CHECK_CUDA_ERROR(msg)                                                \
  {                                                                          \
    ...
    CHECK_EQ(e, cudaSuccess, __FILE__,__LINE__) << (msg) << " CUDA: " << cudaGetErrorString(e); \
  }
...
#define CUBLAS_CALL(func)                                       \
  {                                                             \
    ...
    CHECK_EQ(e, CUBLAS_STATUS_SUCCESS, __FILE__, __LINE__)                          \
        << "cuBLAS: " << nnet::CublasGetErrorString(e); \
  }
...
#define CURAND_CALL(func)                                       \
  {                                                             \
    ...
    CHECK_EQ(e, CURAND_STATUS_SUCCESS, __FILE__, __LINE__)                          \
        << "cuRAND: " << nnet::CurandGetErrorString(e); \
  }

#define CUDNN_CALL(func)                                                      \
  {                                                                           \
    cudnnStatus_t e = (func);                                                 \
    CHECK_EQ(e, CUDNN_STATUS_SUCCESS, __FILE__, __LINE__) << "cuDNN: " << cudnnGetErrorString(e); \
  }
